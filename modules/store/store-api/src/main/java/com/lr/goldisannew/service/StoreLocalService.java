...
/**
 * Provides the local service interface for Store. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StoreLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StoreLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.lr.goldisannew.service.impl.StoreLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the store local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StoreLocalServiceUtil} if injection and service tracking are not available.
	 */
    ...
    Store addStore(long branchId, String branchName, String address, long contactNumber);
}
