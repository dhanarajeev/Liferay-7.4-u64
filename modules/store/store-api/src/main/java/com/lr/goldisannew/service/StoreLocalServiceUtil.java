...
/**
 * Provides the local service utility for Store. This utility wraps
 * <code>com.lr.goldisannew.service.impl.StoreLocalServiceImpl</code> and
 ...
 * @generated
 */
public class StoreLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.lr.goldisannew.service.impl.StoreLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Store addStore(Store store) {
		return getService().addStore(store);
	}
	...
	public static Store createStore(long storeId) {
		return getService().createStore(storeId);
	}
	 ...
	 */
	public static Store deleteStore(long storeId) throws PortalException {
		return getService().deleteStore(storeId);
	}
	...
	public static Store deleteStore(Store store) {
		return getService().deleteStore(store);
	}
	...
	public static Store fetchStore(long storeId) {
		return getService().fetchStore(storeId);
	}
	 ...
	 * @throws PortalException if a store with the primary key could not be found
	 */
	public static Store getStore(long storeId) throws PortalException {
		return getService().getStore(storeId);
	}
	 ...
	 */
	public static List<Store> getStores(int start, int end) {
		return getService().getStores(start, end);
	}
	...
	public static int getStoresCount() {
		return getService().getStoresCount();
	}
	...
	public static Store updateStore(Store store) {
		return getService().updateStore(store);
	}

	public static StoreLocalService getService() {
		return _service;
	}

	private static volatile StoreLocalService _service;

	public static Store addStore(long branchId , String branchName , String address , long contactNumber) {
