...
package com.lr.goldisan.service.persistence.impl;
...
import com.lr.goldisan.model.CompanyTable;
import com.lr.goldisan.model.impl.CompanyImpl;
import com.lr.goldisan.model.impl.CompanyModelImpl;
import com.lr.goldisan.service.persistence.CompanyPersistence;
import com.lr.goldisan.service.persistence.CompanyUtil;
import com.lr.goldisan.service.persistence.impl.constants.lrPersistenceConstants;
 ...
 * @generated
 */
@Component(service = CompanyPersistence.class)
public class CompanyPersistenceImpl
	 ...
	 */
	@Override
	public List<Company> findByUuid(
	...
	public List<Company> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Company>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Company company : list) {
					if (!uuid.equals(company.getUuid())) {
						list = null;
	...
	public Company[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, company, uuid, orderByComparator, true);

			array[1] = company;

			array[2] = getByUuid_PrevAndNext(
				session, company, uuid, orderByComparator, false);
	...
	protected Company getByUuid_PrevAndNext(
		Session session, Company company, String uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(company.uuid IS NULL OR company.uuid = '')";
	 ...
	 */
	@Override
	public List<Company> findByUuid_C(
	...
	public Company findByUuid_C_First(
		...
		Company company = fetchByUuid_C_First(
	...
	public Company fetchByUuid_C_First(
		...
		List<Company> list = findByUuid_C(
	...
	public Company findByUuid_C_Last(
		...
		Company company = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 =
		"(company.uuid IS NULL OR company.uuid = '') AND ";
	...
	public void clearCache() {
		...
		finderCache.clearCache(CompanyImpl.class);
	}
	...
	public void clearCache(Company company) {
		entityCache.removeResult(CompanyImpl.class, company);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(CompanyImpl.class, primaryKey);
		}
	}
	...
	public Company create(long companyId) {
		...
		company.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Company updateImpl(Company company) {
		...
		entityCache.putResult(CompanyImpl.class, companyModelImpl, false, true);
