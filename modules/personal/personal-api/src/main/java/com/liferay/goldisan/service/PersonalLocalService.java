...
/**
 * Provides the local service interface for Personal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PersonalLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PersonalLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.goldisan.service.impl.PersonalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the personal local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PersonalLocalServiceUtil} if injection and service tracking are not available.
	 */
    ...
    Personal addPersonal(String firstName, String lastName, String emailAddress, long phoneNumber, String createPassword, String conformPassword, String address);
}
