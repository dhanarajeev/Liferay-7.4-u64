...
/**
 * Provides the local service utility for Personal. This utility wraps
 * <code>com.liferay.goldisan.service.impl.PersonalLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PersonalLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.goldisan.service.impl.PersonalLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Personal addPersonal(Personal personal) {
		return getService().addPersonal(personal);
	}
	 ...
	 */
	public static Personal createPersonal(String firstName, String lastName, String emailAddress, long personId, String createPassword, String conformPassword, String address) {
		return getService().createPersonal(personId);
	}
	 ...
	 */
	public static Personal deletePersonal(long personId)
		throws PortalException {

		return getService().deletePersonal(personId);
	}
	 ...
	 * @return the personal that was removed
	 */
	public static Personal deletePersonal(Personal personal) {
		return getService().deletePersonal(personal);
	}
	...
	public static Personal fetchPersonal(long personId) {
		return getService().fetchPersonal(personId);
	}
	 ...
	 * @throws PortalException if a personal with the primary key could not be found
	 */
	public static Personal getPersonal(long personId) throws PortalException {
		return getService().getPersonal(personId);
	}
	 ...
	 */
	public static List<Personal> getPersonals(int start, int end) {
		return getService().getPersonals(start, end);
	}
	 ...
	 */
	public static int getPersonalsCount() {
		return getService().getPersonalsCount();
	}
	 ...
	 */
	public static Personal updatePersonal(Personal personal) {
		return getService().updatePersonal(personal);
	}

	public static PersonalLocalService getService() {
		return _service;
	}

	private static volatile PersonalLocalService _service;
